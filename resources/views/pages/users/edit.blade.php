    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Perbarui detail akun dan grup peran
            </p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('users.update', $user->id) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $user->name) }}" placeholder="Contoh: John Doe"
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $user->email) }}" placeholder="Contoh: user@gmail.com"
                ...
                <div>
                    ...
                    <input type="password" name="password" placeholder="Masukkan kata sandi baru"
                        class="h-11 w-full rounded-lg border @error('password') border-red-500 @else border-gray-300 @enderror bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:text-white/90 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10" />
                    @error('password')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="user_code" value="{{ old('user_code', $user->user_code) }}" placeholder="Contoh: 17800T60"
